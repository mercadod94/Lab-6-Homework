...
Level.prototype.obstacleAt = function(pos, size){
    ...
    // Consider sides, top, and bottom pf the level
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  // find if there is a wall
  var obstacle = level.obstacleAt(newPos, this.size);
  // Move it there's no wall
  if(obstacle != "wall")
      this.pos = newPos;
};
...
Player.prototype.moveY = function(step, level, keys) {
  // Accelerate players downwards always
  ...
  //floor is also an obstacle -- only allow players to jump
